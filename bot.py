    ...
    if usr_cmd == "/start":
        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Main Channel", url="https://t.me/Anime_Kun_Channel")
                    ],
                    [
                    ...
                    [
                        InlineKeyboardButton("Discussion Group", url="https://t.me/+JgjRWhYBOaA0ZGRl"),
                        InlineKeyboardButton(" Support Group", url="https://t.me/+JgjRWhYBOaA0ZGRl")
                    ]
                ]
            )
        )
...
async def main(bot: Client, message: Message):
    ...
    if message.chat.type == enums.ChatType.PRIVATE:
        ...
        if message.from_user.id in Config.BANNED_USERS:
            await message.reply_text("Sorry, You are banned!\n\nContact [Support](https://t.me/Chowdhury_Siam)",
                                     disable_web_page_preview=True)
            return
                ...
                [
                    [
                        InlineKeyboardButton("Source Codes of Bot",
                                             url="https://github.com/Siam19395/TG-FileStore")
                    ],
                    [
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my Owner [Support](https://t.me/Chowdhury_Siam).",
                        disable_web_page_preview=True
                    )
                    return
                ...
                await cmd.message.edit(
                    text="Something went Wrong. Contact my Owner [Support](https://t.me/Chowdhury_Siam).",
                    disable_web_page_preview=True
                )
                return
        await cmd.message.edit(
